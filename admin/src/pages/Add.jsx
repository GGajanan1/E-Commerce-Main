...
const Add = ({ token }) => {
  ...
  const [count, setCount] = useState(0); // Product count state
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      formData.append("count", count); // Append product count to form data
  ...
  const resetForm = () => {
    ...
    setSizes([]);
    setBestSeller(false);
    setCount(0); // Reset product count
  };
  ...
  return (
    ...
    >
      ...
      <div className="w-full mt-2">
        <p className="mb-2 text-lg font-semibold">Product Count (Inventory)</p>
        <input
